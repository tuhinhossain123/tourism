        ...
        <div className="flex flex-col lg:flex-row justify-between lg:items-center gap-8 lg:gap-0">
          ...
          <div className="space-y-6 md:space-x-10 lg:space-x-6">
            <input
              type="email"
              name="from_email"
              className="input bg-transparent border border-[#47545F] rounded-none font-bold pt-[13px] pr-14 lg:pr-[106px] pb-[13px] pl-[28px] text-black placeholder:text-[#47545F] focus:outline-none"
